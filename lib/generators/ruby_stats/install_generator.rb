  ...
  module Generators
	class InstallGenerator < Rails::Generators::Base
	  ...
	  def add_programming_language
		...
		p_language = RubyStats::PROGRAMMING_LANGUAGE
	  ...
	  def add_metric
		p_language = ProgrammingLanguage.find_by_name(RubyStats::PROGRAMMING_LANGUAGE)
		  
		begin
		  Metric.table_exists?
		  metric_analyser = RubyStats::ANALYSER
		  metric_name = RubyStats::NAME
	  ...
	  def end_install
		puts "#{RubyStats::ANALYSER}: #{RubyStats::PROGRAMMING_LANGUAGE} #{RubyStats::NAME} sucessfully installed!"
	  end
	end
  end
end
